...
namespace AnimalManagement
{
    public partial class frmDMChatLieu : Form
    {
        ...
        private void LoadDataGridView()
        {
            ...
            dgvChatLieu.Columns[0].HeaderText = "Mã động vật";
            dgvChatLieu.Columns[1].HeaderText = "Loại động vật";
        ...
        private void dgvChatLieu_Click(object sender, EventArgs e)
        {
            ...
            txtMaChatLieu.Text = dgvChatLieu.CurrentRow.Cells["category_id"].Value.ToString();
            txtTenChatLieu.Text = dgvChatLieu.CurrentRow.Cells["category_name"].Value.ToString();
            btnSua.Enabled = true;
            btnXoa.Enabled = true;
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Bạn phải nhập loài động vật", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                txtTenChatLieu.Focus();
                return;
            }
            sql = "Select category_id From Category where category_id=N'" + txtMaChatLieu.Text.Trim() + "'";
            ...
            sql = "INSERT INTO Category VALUES(N'" +
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                sql = "DELETE Category WHERE category_id=N'" + txtMaChatLieu.Text + "'";
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE Category SET category_name=N'" +
                txtTenChatLieu.Text.ToString() +
                "' WHERE category_id=N'" + txtMaChatLieu.Text + "'";
